...
function createTemperatureChart(responseData, chartId) {
    ...
    const data = {
        ...
        datasets: [
            {
                label: isFreezeStress ? 'Min Temperature (°C)' : 
                       isNightHeatStress ? 'Min Temperature (°C)' : 'Max Temperature (°C)',
                data: isFreezeStress ? responseData.min_temps :
                      isNightHeatStress ? responseData.min_temps : responseData.max_temps,
                borderColor: isFreezeStress ? 'blue' :
                           isNightHeatStress ? 'yellow' : 'red',
                backgroundColor: isFreezeStress ? 'blue' :
                               isNightHeatStress ? 'yellow' : 'red',
                fill: false,
                tension: 0.1
            },
        ...
        options: {
            ...
            scales: {
                ...
                y: {
                    ...
                    suggestedMin: isFreezeStress ? -45 : 20,
                    suggestedMax: isFreezeStress ? 5 : 42
                }
            },
            plugins: {
                legend: {
